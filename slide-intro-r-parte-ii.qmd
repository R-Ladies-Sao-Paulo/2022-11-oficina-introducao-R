...
-   Nesse caso, precisam ser escritos entre aspas o R entender que **o valor que esse objeto armazena é um texto.**
...
-   Os objetos podem conter dados de diferentes naturezas (um texto, um número, um booleano). É o que chamamos de **classe**. **É o quê estamos armazenando.**
...
| **numeric**   | números racionais (número que pode ser representado por uma fração de dois números inteiros |
...
![](https://github.com/R-Ladies-Sao-Paulo/2022-11-oficina-introducao-R/blob/main/img/img07_pipe.PNG?raw=true)
...
![Versão no Excel](https://github.com/R-Ladies-Sao-Paulo/2022-11-oficina-introducao-R/blob/main/img/img02_excel.PNG?raw=true)
